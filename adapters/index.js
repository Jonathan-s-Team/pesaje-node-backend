const { User, Role, Broker, PaymentInfo, Person, RolePermission, Option, Client, ShrimpFarm, Period, SizePrice, Company, Size, Purchase, PaymentMethod, PurchasePaymentMethod, Logistics, LogisticsType, LogisticsItem } = require('../models');
...
if (dbType === 'mongo') {
    ...
    logisticsTypeAdapter = new MongooseGenericAdapter(LogisticsType);
