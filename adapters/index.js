const { User, Role, Broker, PaymentInfo, Person, RolePermission, Option } = require('../models');
...
module.exports = { userAdapter, personAdapter, brokerAdapter, paymentInfoAdapter, roleAdapter, rolePermissionAdapter, optionAdapter };
